...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Tobias Hertel';
    var email  = 'tobias.hertel@gmx.de';
    ...
    if (!newname) {
        console.log('Please write the new luftdaten name, like: "gulp rename --name mywidgetset" --author "Tobias Hertel"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/luftdaten.png')) {
        fs.renameSync(__dirname + '/admin/luftdaten.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/luftdaten.html')) {
        fs.renameSync(__dirname + '/widgets/luftdaten.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/luftdaten/js/luftdaten.js')) {
        fs.renameSync(__dirname + '/widgets/luftdaten/js/luftdaten.js', __dirname + '/widgets/luftdaten/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/luftdaten')) {
        fs.renameSync(__dirname + '/widgets/luftdaten',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /luftdaten/g,
        ...
        {
            match: /Luftdaten/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Luftdaten'
        },
        {
            match: /Tobias Hertel/g,
            replacement: author
        },
        {
            match: /tobias.hertel@gmx.de/g,
            replacement: email
        }
    ];
    var files = [
